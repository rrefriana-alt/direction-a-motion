...
function forms() {
  ...
  // [data-single] groups are single-select filters owned by their own page
  // script — the generic multi-select toggle would just undo their choice.
  $$('.chips:not([data-single])').forEach(g => $$('.chip', g).forEach(c =>
