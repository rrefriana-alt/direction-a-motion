    ...
    <div class="article">
      ...
      <div class="abyline abyline--bare fade-up" data-delay="2">
        ...
        <div>
          ...
          <span>{{ $post->published_date?->format('d M Y') }} &nbsp;·&nbsp; {{ $post->view_count }} <span>dibaca</span></span>
        </div>
        <div class="ashare">
          <button class="ashare__btn" type="button" data-copylink="{{ route('journal.show', ['locale'=>$locale, 'slug'=>$post->slug]) }}" aria-label="Copy link">
            ...
            <span class="ashare__tip">Salin tautan</span>
          </button>
  ...
  <div class="shell">
    <div class="article">
      ...
      <div class="abyline fade-up">
        ...
        <div>
          <strong>{{ $post->author }}</strong>
          <span>Kontributor, Fugo Creative Group — Bandung / Jakarta / Bali</span>
        </div>
      </div>
      ...
      <nav class="aprevnext fade-up" aria-label="More articles">
        ...
        <a class="aprevnext__link" href="{{ route('journal.show', $newerPost->slug) }}">
          <span class="bcard__meta"><span aria-hidden="true">←</span> <span>Baru</span></span>
        ...
        <a class="aprevnext__link aprevnext__link--next" href="{{ route('journal.show', $olderPost->slug) }}">
          <span class="bcard__meta"><span>Lama</span> <span aria-hidden="true">→</span></span>
