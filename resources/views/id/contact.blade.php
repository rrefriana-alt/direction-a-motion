...
<title>Kontak — Fugo Creative — Bandung, Jakarta & Bali</title>
...
<header class="nav is-solid">
  <div class="nav__in">
    ...
    <nav class="nav__links" aria-label="Primary">
      ...
      <a class="nav__link is-active" href="{{ url($locale.'/contact') }}">Kontak</a>
    </nav>
    <div class="nav__side">
...
<section class="phead">
  ...
  <div class="shell">
    <p class="crumb fade-up"><a href="{{ url($locale) }}">Fugo</a> <span>/</span> <span>Kontak</span></p>
  ...
  <div class="shell grid g-12">
    <div class="col-7">
      <form action="{{ route('contact.send') }}" method="POST" class="fade-up" novalidate>
        @csrf
        <p class="mono faint">Apa yang Anda butuhkan?</p>
        <div class="chips" role="group">
          <button type="button" class="chip on">Desain</button>
          <button type="button" class="chip">Film — TVC</button>
          <button type="button" class="chip">Acara</button>
          <button type="button" class="chip">Merch</button>
          <button type="button" class="chip">Belum yakin</button>
        </div>

        <div class="field" style="margin-top:2rem">
          <label for="f-name">Nama Anda</label>
        ...
        <div class="field">
          <label for="f-msg">Apa yang akan kita buat?</label>
        ...
        <button class="btn btn--green mt-l" type="submit" data-magnet=".3">Kirim brief</button>
        @if(session('success'))
    ...
    <div class="col-5">
      <div class="card fade-up" data-delay="1">
        ...
        <div class="card__tags" style="margin-top:1.6rem">
          <span class="tag">Balasan dalam 1 hari kerja</span>
        </div>
      </div>

      <div class="card fade-up mt-m" data-delay="2">
        <p class="card__num">Kantor</p>
      ...
      <div class="card fade-up mt-m" data-delay="3">
        <p class="card__num">Karier</p>
        <h3 style="font-size:1.4rem">Gabung tim</h3>
        <p>Kami merekrut desainer, editor, dan produser di Bandung dan Jakarta. Kirim karya, bukan surat lamaran.</p>
        <a class="tlink green mt-s" href="mailto:{{ $contactEmail }}">Kirim portofolio</a>
      </div>
    </div>
  </div>
</section>
