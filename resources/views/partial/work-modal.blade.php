{{--
  One case-study modal. Rendered once per work item inside /work, hidden until
  its row is clicked — keeping it in the DOM (rather than templating it in JS)
  is what lets the site's EN/ID switcher translate the copy like any other page.

  Expects: $w (work item array), $prev / $next (slug or null).
--}}
