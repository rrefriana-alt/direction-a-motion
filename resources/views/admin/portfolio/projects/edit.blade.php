            ...
            <div class="tab-content active" id="tab-overview">
                <div class="group-card">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" name="title" maxlength="120" data-max="120" class="form-control" value="{{ old('title', $project->title) }}" required>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        @if($isEn)
                            <input type="text" name="scope_en" maxlength="80" data-max="80" class="form-control" value="{{ $scopeEnVal }}" placeholder="Concept — Script — Production">
                        @else
                            <input type="text" name="scope_id" maxlength="80" data-max="80" class="form-control" value="{{ $scopeIdVal }}" placeholder="Konsep — Naskah — Produksi">
                        @endif
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        @if($isEn)
                            <input type="text" name="division_en" maxlength="60" data-max="60" class="form-control" value="{{ $divEnVal }}" placeholder="Production House">
                        @else
                            <input type="text" name="division_id" maxlength="60" data-max="60" class="form-control" value="{{ $divIdVal }}" placeholder="Rumah Produksi">
                        @endif
                    </div>
                </div>
...
function addAbout(){
    const html=`<div class="list-item"><button type="button" class="remove-btn" onclick="this.closest('.list-item').remove()"><i class="bi bi-x"></i></button><textarea name="about_${IS_EN?'en':'id'}[]" maxlength="600" data-max="600" class="form-control" rows="2" placeholder="${IS_EN?'English paragraph':'Paragraf Bahasa'}"></textarea></div>`;
