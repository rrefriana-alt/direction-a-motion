...
<section class="phead">
  ...
  <div class="shell">
    <p class="crumb fade-up"><a href="{{ url('') }}">Fugo</a> <span>/</span> <a href="{{ url('work') }}" data-en="Work" data-id="Karya">Work</a> <span>/</span> <span>BRI</span></p>
...
<section class="section" style="padding-top:0">
  <div class="shell">
    <div class="stats">
      ...
      <div class="stat fade-up" data-delay="1"><p class="stat__n"><span data-count="6">0</span></p><p class="stat__l" data-en="Brief to broadcast" data-id="Brief ke tayang">Brief to broadcast</p></div>
...
<section class="section" style="padding-top:0">
  <div class="shell row between center gap-m">
    <a class="tlink" href="{{ url('work') }}" data-en="← All work" data-id="← Semua karya">← All work</a>
    <a class="tlink green" href="{{ url('work') }}" data-en="Next project — data-id="Proyek berikutnya →">Next project →</a>
  </div>
</section>
