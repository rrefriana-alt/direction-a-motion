...
<header class="nav">
  <div class="nav__in">
    ...
    <nav class="nav__links" aria-label="Primary">
      <a class="nav__link is-active" href="{{ url($locale) }}">Home</a>
  ...
  <div class="shell hero__in">
    ...
    <div class="hero__meta">
      ...
      <div class="hero__cta" data-delay="2">
        ...
        <a class="btn btn--ghost" href="{{ url($locale.'/services') }}">What we do</a>
      </div>
    </div>
  ...
  <div class="shell grid g-12">
    ...
    <div class="col-7">
      ...
      <div class="row gap-m mt-l fade-up" data-delay="1">
        <a class="tlink green" href="{{ url($locale.'/about') }}">Read our story</a>
        <span class="faint">·</span>
        <a class="tlink" href="{{ url($locale.'/contact') }}">Work with us</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="shell">
    <div class="svc__grid">
      ...
      <div class="svc__sticky">
        <p class="eyebrow">02 — <span>Capabilities</span></p>
        @php
        ...
        <a class="btn btn--ghost mt-l" href="{{ url($locale.'/services') }}" data-magnet=".25">All capabilities</a>
      </div>
...
<section class="section" style="padding-bottom:0">
  <div class="shell row between end gap-m">
    <div>
      <p class="eyebrow">03 — <span>Selected work</span></p>
      <h2 class="display h-xxl mt-s fade-up" data-delay="1">Proof, not<br>promises</h2>
    </div>
    <a class="tlink fade-up" data-delay="2" href="{{ url($locale.'/work') }}">All projects →</a>
  </div>
</section>
    ...
    <div class="hscroll__track">
      ...
      <article class="wcard" data-cursor="Case study">
        ...
        <div class="wcard__body">
          ...
          <a class="tlink green mt-s" href="{{ url($locale.'/work') }}">View project</a>
        </div>
      </article>
      @endforeach
    </div>
...
<section class="section">
  <div class="shell">
    <p class="eyebrow">04 — <span>Who we work with</span></p>
    <h2 class="display h-xl mt-s mb fade-up" data-delay="1" style="margin-bottom:2.5rem">Regulated, demanding,<br>high-visibility brands</h2>

    <div class="sectors fade-up" data-delay="2">
      @foreach($sectors as $sector)
      <div class="sector">
        <h4>{{ $sector->heading_en }}</h4>
        <ul>
...
<section class="section" style="padding-top:0">
  <div class="shell">
    <div class="quote fade-up">
      <div>
        <p class="eyebrow" style="margin-bottom:1.6rem">06 — <span>From the founder</span></p>
        <blockquote>
  ...
  <div class="shell">
    ...
    <div class="bfeat mt-l">
      <article class="bfeat__card fade-up" data-cursor="Read">
        ...
        <div class="bfeat__body">
          <p class="card__num">01 — <span>Latest</span> &nbsp;·&nbsp; {{ $feat->published_date?->format('d M Y') }}</p>
      ...
      <div class="bfeat__side">
        ...
        <article class="bmini fade-up" data-delay="{{ $j + 1 }}" data-cursor="Read">
          ...
          <div class="bmini__txt">
            ...
            <a class="tlink green" href="{{ route('journal.show', ['locale'=>$locale, 'slug'=>$post->slug]) }}">Read →</a>
          </div>
        </article>
        @endforeach
        <a class="bmini bmini--more fade-up" data-delay="3" href="{{ route('journal.index', ['locale'=>$locale]) }}">
          <span class="bmini__txt">
            <span class="bcard__meta"><span>Archive</span></span>
            <span class="bmini__more-t">Browse all articles →</span>
          </span>
    ...
    <div class="bfeat mt-l">
      <article class="bfeat__card fade-up" data-cursor="Read">
        ...
        <div class="bfeat__body">
          <p class="card__num">01 — <span>Latest</span></p>
      ...
      <div class="bfeat__side">
        ...
        <article class="bmini fade-up" data-delay="{{ $j + 1 }}">
          ...
          <div class="bmini__txt">
            ...
            <a class="tlink green" href="{{ route('journal.index', ['locale'=>$locale]) }}">Browse →</a>
          </div>
        </article>
        @endforeach
        <a class="bmini bmini--more fade-up" data-delay="3" href="{{ route('journal.index', ['locale'=>$locale]) }}">
