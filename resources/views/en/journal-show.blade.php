...
<section class="phead">
  ...
  <div class="shell">
    <div class="article">
      <p class="crumb fade-up"><a href="{{ url($locale) }}">Fugo</a> <span>/</span> <a href="{{ route('journal.index', ['locale'=>$locale]) }}">Journal</a> <span>/</span> <span>{{ $post->category_display }}</span></p>
  ...
  <div class="shell">
    <div class="article">
      ...
      <div class="card__tags fade-up" style="margin-top:2.2rem">
        <a class="tag" href="{{ route('journal.index', ['category' => $post->category]) }}" style="text-decoration:none">{{ $post->category_display }}</a>
        <a class="tag" href="{{ route('journal.index', ['locale'=>$locale]) }}" style="text-decoration:none">Studio journal</a>
      </div>
      ...
      <div class="mt-l fade-up">
        <a class="tlink green" href="{{ route('journal.index', ['locale'=>$locale]) }}">← Back to journal</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="shell">
    <div class="row between end gap-m">
      <div>
        ...
        <h2 class="display h-xl mt-s fade-up" data-delay="1">More from<br>the studio</h2>
      </div>
