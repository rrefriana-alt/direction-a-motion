...
<section class="phead">
  ...
  <div class="shell">
    <p class="crumb fade-up"><a href="{{ url($locale) }}">Fugo</a> <span>/</span> <a href="{{ url($locale.'/work') }}">Work</a> <span>/</span> <span>BRI</span></p>
    ...
    <div class="row gap-l mt-m fade-up" data-delay="2">
      <div><p class="mono faint">Client</p><p class="mt-s">Bank Rakyat Indonesia</p></div>
      <div><p class="mono faint">Scope</p><p class="mt-s">Concept — Script — Production — Post</p></div>
      <div><p class="mono faint">Year</p><p class="mt-s">2025</p></div>
      <div><p class="mono faint">Division</p><p class="mt-s">Production House</p></div>
    </div>
  </div>
</section>
...
<section class="section" style="padding-top:0">
  <div class="shell grid g-12">
    <div class="col-4"><p class="eyebrow fade-up">The brief</p></div>
    <div class="col-8">
      <p class="h-lg fade-up" style="max-width:26ch">Explain a product nobody can hold.</p>
      <p class="lede mt-m fade-up" data-delay="1">BRImo's virtual debit card had no physical object to film, no packaging to unbox, and a compliance list longer than the script. The commercial had to make an invisible product feel safer than a plastic one.</p>
    </div>
  </div>
</section>
...
<section class="section" style="padding-top:0">
  <div class="shell grid g-12">
    <div class="col-4"><p class="eyebrow fade-up">What we did</p></div>
    <div class="col-8">
      <div class="steps">
        <div class="step fade-up"><span class="step__n">01</span><div class="step__b"><h3>Found the human moment</h3><p>We stopped selling the card and started filming the two seconds after someone realises they can pay without it.</p></div></div>
        <div class="step fade-up" data-delay="1"><span class="step__n">02</span><div class="step__b"><h3>Built the UI in camera</h3><p>Screen content was pre-rendered and played back on set, so compliance approved the exact frames that shipped.</p></div></div>
        <div class="step fade-up" data-delay="2"><span class="step__n">03</span><div class="step__b"><h3>Cut once, delivered nine ways</h3><p>One shoot produced the 30s TVC, three 15s cutdowns, vertical social edits and in-branch LED loops.</p></div></div>
      </div>
    </div>
  </div>
</section>
...
<section class="section" style="padding-top:0">
  <div class="shell">
    <div class="stats">
      <div class="stat fade-up"><p class="stat__n"><span data-count="9">0</span></p><p class="stat__l">Deliverables from one shoot</p></div>
      <div class="stat fade-up" data-delay="1"><p class="stat__n"><span data-count="6">0</span></p><p class="stat__l">Brief to broadcast</p></div>
      <div class="stat fade-up" data-delay="2"><p class="stat__n"><span data-count="0">0</span></p><p class="stat__l">Compliance reshoots</p></div>
      <div class="stat fade-up" data-delay="3"><p class="stat__n"><span data-count="3">0</span></p><p class="stat__l">Channels launched same week</p></div>
    </div>
  </div>
</section>
...
<section class="section" style="padding-top:0">
  <div class="shell row between center gap-m">
    <a class="tlink" href="{{ url($locale.'/work') }}">← All work</a>
    <a class="tlink green" href="{{ url($locale.'/work') }}"Proyek berikutnya →">Next project →</a>
  </div>
</section>
