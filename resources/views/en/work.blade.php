...
<section class="phead">
  ...
  <div class="shell">
    <p class="crumb fade-up"><a href="{{ url($locale) }}">Fugo</a> <span>/</span> <span>Work</span></p>
    <h1 class="display h-xxl mt-s fade-up" data-delay="1">Selected<br>work</h1>
    <p class="lede mt-m fade-up" data-delay="2">Ten projects that show the range: a national TVC, a dealer system used in 200+ locations, a three-day expo, and 12,000 kits shipped on time.</p>
  </div>
</section>
<section class="section" style="padding-top:clamp(2rem,4vw,3rem)">
  <div class="shell">
    <div class="chips fade-up" style="margin-bottom:2.5rem" role="group" aria-label="Filter">
      ...
      <button class="chip" data-filter="Production">Production</button>
    ...
    <div class="bfeat mt-l">
      <article class="bfeat__card fade-up" data-cursor="Read">
        <a class="bfeat__art" href="{{ route('journal.show', ['locale'=>$locale, 'slug'=>$feat->slug]) }}" aria-label="{{ $feat->title }}">
          ...
          @else
            @include('partials.jart', ['seed' => ((int) crc32($feat->id))])
          @endif
