...
<aside class="sidebar" :class="{ open: sidebarOpen }" id="sidebar">
    ...
    <div class="sb-scroll">
        ...
        <ul class="sb-nav">
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><i class="bi bi-grid-1x2-fill sb-icon"></i> Dashboard</a></li>
        </ul>
        <div class="sb-section"><div class="sb-section-label">Page Manager</div></div>
        <ul class="sb-nav">
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.content')); ?>?page=home" class="<?php echo e(request()->routeIs('admin.content') && (request('page','home')==='home' || !request('page')) ? 'active' : ''); ?>"><i class="bi bi-house-fill sb-icon"></i> Home Page</a></li>
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.content')); ?>?page=work" class="<?php echo e(request()->routeIs('admin.content') && request('page')==='work' ? 'active' : ''); ?>"><i class="bi bi-folder2-open sb-icon"></i> Work Page</a></li>
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.content')); ?>?page=services" class="<?php echo e(request()->routeIs('admin.content') && request('page')==='services' ? 'active' : ''); ?>"><i class="bi bi-layers sb-icon"></i> Services Page</a></li>
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.content')); ?>?page=about" class="<?php echo e(request()->routeIs('admin.content') && request('page')==='about' ? 'active' : ''); ?>"><i class="bi bi-people-fill sb-icon"></i> About / Studio</a></li>
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.content')); ?>?page=contact" class="<?php echo e(request()->routeIs('admin.content') && request('page')==='contact' ? 'active' : ''); ?>"><i class="bi bi-envelope-fill sb-icon"></i> Contact Page</a></li>
        </ul>
        <div class="sb-section"><div class="sb-section-label">Content</div></div>
        <ul class="sb-nav">
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.projects.index')); ?>" class="<?php echo e(request()->routeIs('admin.projects.*') ? 'active' : ''); ?>"><i class="bi bi-collection-fill sb-icon"></i> Projects</a></li>
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.services.index')); ?>" class="<?php echo e(request()->routeIs('admin.services.*') ? 'active' : ''); ?>"><i class="bi bi-grid-3x3-gap-fill sb-icon"></i> Services</a></li>
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.news.index')); ?>" class="<?php echo e(request()->routeIs('admin.news.*') ? 'active' : ''); ?>"><i class="bi bi-newspaper sb-icon"></i> News / Blog</a></li>
        </ul>
        <div class="sb-section"><div class="sb-section-label">Engagement</div></div>
        <ul class="sb-nav">
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.careers.index')); ?>" class="<?php echo e(request()->routeIs('admin.careers.*') ? 'active' : ''); ?>"><i class="bi bi-person-badge-fill sb-icon"></i> Careers</a></li>
            <li class="sb-nav-item">
                <?php $unread = \App\Models\Message::where('is_read', false)->count(); ?>
                <a href="<?php echo e(route('admin.messages.index')); ?>" class="<?php echo e(request()->routeIs('admin.messages.*') ? 'active' : ''); ?>"><i class="bi bi-chat-dots-fill sb-icon"></i> Messages <?php if($unread > 0): ?><span class="sb-badge"><?php echo e($unread); ?></span><?php endif; ?></a>
            </li>
        </ul>
        <div class="sb-section"><div class="sb-section-label">System</div></div>
        <ul class="sb-nav">
            <li class="sb-nav-item"><a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>"><i class="bi bi-shield-person-fill sb-icon"></i> Admin Users</a></li>
        </ul>
    </div>
    <div class="sb-footer">
        <div class="sb-user">
            <div class="sb-avatar"><?php echo e(strtoupper(substr(Auth::user()->name ?? 'A', 0, 1))); ?></div>
...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <div class="topbar-breadcrumb">
            ...
            <span class="bc-current"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
        </div>
        <div class="topbar-right">
            <?php $msgCount = \App\Models\Message::where('is_read',false)->count(); ?>
            <a href="<?php echo e(route('admin.messages.index')); ?>" class="topbar-action" title="Messages">
                <i class="bi bi-chat-dots"></i>
                <?php if($msgCount > 0): ?><span class="dot"></span><?php endif; ?>
            </a>
            <div class="topbar-divider"></div>
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="topbar-view-site">
