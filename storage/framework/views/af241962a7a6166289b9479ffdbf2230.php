<?php $__env->startSection('title', 'Home Management'); ?>
<?php $__env->startSection('page-title', 'Home Management'); ?>
...
<div class="row g-3">
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.hero.edit')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.clients.index')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.manifesto.edit')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.stats.index')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.capabilities-header.edit')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.capabilities.index')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.sectors.index')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.process.index')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.founder.edit')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.marquee.index')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.cta.edit')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.services-page.edit')); ?>" class="dashboard-card">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('admin.home.footer.edit')); ?>" class="dashboard-card">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Reyhan\Fugo Creative\direction-a-motion(git)\direction-a-motion\resources\views/admin/home/index.blade.php ENDPATH**/ ?>