<?php $__env->startSection('title', 'Sectors'); ?>
...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <a href="<?php echo e(route('admin.about.sectors.create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Add Sector</a>
</div>
...
<div class="svc-list" id="sectorsList">
    ...
    <?php echo $__env->make('admin.about.sectors._sector_card', ['sector' => $sector, 'index' => $index], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveOrder() {
        ...
        fetch('<?php echo e(route("admin.about.sectors.reorder")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                'X-Requested-With': 'XMLHttpRequest',
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Reyhan\Fugo Creative\direction-a-motion(git)\direction-a-motion\resources\views/admin/about/sectors/index.blade.php ENDPATH**/ ?>