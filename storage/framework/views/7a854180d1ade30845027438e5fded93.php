...
<header class="nav is-solid">
  <div class="nav__in">
    ...
    <nav class="nav__links" aria-label="Primary">
      ...
      <a class="nav__link is-active" href="/about" data-en="Studio" data-id="Studio">Studio</a>
...
<section class="phead">
  ...
  <div class="shell">
    <p class="crumb fade-up"><a href="/">Fugo</a> <span>/</span> <span data-en="Studio" data-id="Studio">Studio</span></p>
    ...
    <div class="quote fade-up">
      <div>
        ...
        <div class="quote__by">
            ...
            <?php else: ?>
                <span class="avatar" aria-hidden="true"><?php echo e(substr($content['about']['founder']['name'], 0, 2)); ?></span>
            <?php endif; ?>
