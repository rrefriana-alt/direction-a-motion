...
<header class="nav is-solid">
  <div class="nav__in">
    ...
    <nav class="nav__links" aria-label="Primary">
      <a class="nav__link" href="<?php echo e(url('')); ?>" data-en="Home" data-id="Beranda">Home</a>
      ...
      <a class="nav__link is-active" href="<?php echo e(url('about')); ?>" data-en="About" data-id="Tentang">About</a>
    ...
    <div class="nav__side">
      ...
      <a class="btn btn--green btn--sm" href="<?php echo e(url('contact')); ?>" data-magnet=".28" data-en="Start a project" data-id="Mulai proyek">Start a project</a>
...
<section class="phead">
  ...
  <div class="shell">
    <p class="crumb fade-up"><a href="<?php echo e(url('')); ?>">Fugo</a> <span>/</span> <span data-en="About" data-id="Tentang">About</span></p>
    <h1 class="display h-xxl mt-s fade-up" data-delay="1"><?php echo \App\Models\Setting::get('about_page_headline', 'A creative group,<br>not a vendor list'); ?></h1>
    <p class="lede mt-m fade-up" data-delay="2"><?php echo e(\App\Models\Setting::get('about_page_subtitle', 'We started in 2016 printing merchandise. Nine years later we run five divisions across three cities — and we still answer the phone ourselves.')); ?></p>
  </div>
</section>
<section class="section" style="padding-top:clamp(2rem,4vw,3rem)">
  <div class="shell grid g-12">
    <div class="col-5">
      <p class="eyebrow fade-up"><?php echo e(\App\Models\Setting::get('about_belief_title', 'Our belief')); ?></p>
    </div>
    <div class="col-7">
      <p class="h-lg fade-up" style="font-size:clamp(1.3rem,2.6vw,2rem);max-width:24ch"><?php echo e(\App\Models\Setting::get('about_belief_text', 'Every brief can be solved with creativity, an innovative route, and execution that actually lands.')); ?></p>
      <p class="lede mt-m fade-up" data-delay="1"><?php echo e(\App\Models\Setting::get('about_belief_elaboration', 'We reject the word impossible. Not as a slogan — as a working method: when a route is blocked we go and find the next one, and we tell you what it costs before you commit.')); ?></p>
    </div>
  </div>
</section>
  ...
  <div class="shell grid g-12">
    ...
    <div class="col-8">
      <div class="steps">
        ...
        <div class="step fade-up" <?php if($index > 0): ?> data-delay="<?php echo e(min($index, 5)); ?>" <?php endif; ?>>
          <span class="step__n"><?php echo e($timeline->year); ?></span>
          <div class="step__b"><p class="muted" style="padding-top:.4rem"><?php echo e($timeline->description); ?></p></div>
        </div>
  ...
  <div class="shell">
    <div class="quote fade-up">
      <div>
        ...
        <div class="quote__by">
          <?php if($ceoProfile && $ceoProfile->photo): ?>
            <img src="<?php echo e(asset($ceoProfile->photo)); ?>" alt="<?php echo e($ceoProfile->name); ?>" class="avatar" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
          <?php else: ?>
      ...
      <div class="quote__art">
        <?php if($ceoProfile && $ceoProfile->photo): ?>
          <img src="<?php echo e(asset($ceoProfile->photo)); ?>" alt="<?php echo e($ceoProfile->name); ?>" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
        <?php else: ?>
  ...
  <div class="shell">
    ...
    <div class="fade-up" data-delay="2" style="display: flex; width: 100%; margin-top: 2.5rem; border: 1px solid rgba(255,255,255,.15); border-radius: 16px; overflow: hidden;">
      <div style="flex: 1; padding: 2rem 2.5rem; border-right: 1px solid rgba(255,255,255,.15); box-sizing: border-box;">
        ...
        <p class="muted" style="margin: 0; font-size: 0.9rem; line-height: 1.4; opacity: 0.7;"><?php echo e(\App\Models\Setting::get('contact_address_bdg', 'Jl. Permata Taman Sari Raya No.21, Arcamanik')); ?></p>
      </div>
      <div style="flex: 1; padding: 2rem 2.5rem; border-right: 1px solid rgba(255,255,255,.15); box-sizing: border-box;">
        <h4 style="margin: 0 0 0.8rem 0; font-size: 1.1rem; font-weight: 700; color: #fff;">Jakarta</h4>
        <p class="muted" style="margin: 0; font-size: 0.9rem; line-height: 1.4; opacity: 0.7;"><?php echo e(\App\Models\Setting::get('contact_address_jkt', 'Jl. Srengseng Sawah No.16, Jagakarsa')); ?></p>
      </div>
      <div style="flex: 1; padding: 2rem 2.5rem; box-sizing: border-box;">
        ...
        <p class="muted" style="margin: 0; font-size: 0.9rem; line-height: 1.4; opacity: 0.7;"><?php echo e(\App\Models\Setting::get('contact_address_bali', 'Jl. Tukad Melangit, Samplangan, Gianyar')); ?></p>
      </div>
    </div>
  </div>
</section>
...
<section class="section cta">
  ...
  <div class="shell">
    ...
    <div class="row gap-s mt-l fade-up" data-delay="2" style="justify-content:center">
      <a class="btn btn--green" href="<?php echo e(url('contact')); ?>" data-magnet=".34" data-cursor="Go"><span data-en="Start a project" data-id="Mulai proyek">Start a project</span><span class="ico" aria-hidden="true">↗</span></a>
  ...
  <div class="shell">
    <div class="foot__top">
      ...
      <div>
        ...
        <ul><li><a href="<?php echo e(url('work')); ?>" data-en="Work" data-id="Karya">Work</a></li><li><a href="<?php echo e(url('services')); ?>" data-en="Services" data-id="Layanan">Services</a></li><li><a href="<?php echo e(url('about')); ?>" data-en="About" data-id="Tentang">About</a></li><li><a href="<?php echo e(url('contact')); ?>" data-en="Contact" data-id="Kontak">Contact</a></li><li><a href="<?php echo e(url('contact')); ?>" data-en="Careers" data-id="Karier">Careers</a></li></ul>
      </div>
      <div>
