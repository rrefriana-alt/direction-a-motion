...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <a href="<?php echo e(route('admin.about.statistics.create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Add Statistic</a>
</div>

<?php if($stats->isEmpty()): ?>
...
<div class="svc-list" id="statsList">
    ...
    <div class="svc-card" data-id="<?php echo e($stat->id); ?>">
        <span class="drag-handle"><i class="bi bi-grip-vertical"></i></span>
        <span class="svc-num"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></span>
        <div class="svc-info">
            <div class="svc-label"><?php echo e($stat->label); ?></div>
            <div class="svc-meta">
                <span class="svc-badge svc-badge--val"><?php echo e($stat->value); ?></span>
                <?php if($stat->suffix): ?><span class="svc-badge svc-badge--sfx"><?php echo e($stat->suffix); ?></span><?php endif; ?>
            </div>
        </div>
        <div class="svc-acts">
            <span class="svc-badge <?php echo e($stat->is_active ? 'svc-badge--val' : 'svc-badge--off'); ?>"><?php echo e($stat->is_active ? 'Active' : 'Off'); ?></span>
            <div class="svc-toggle <?php echo e($stat->is_active ? 'on' : ''); ?>" data-toggle-url="<?php echo e(route('admin.about.statistics.toggle', $stat->id)); ?>"></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveOrder() {
        ...
        fetch('<?php echo e(route("admin.about.statistics.reorder")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                'X-Requested-With': 'XMLHttpRequest',
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Reyhan\Fugo Creative\direction-a-motion(git)\direction-a-motion\resources\views/admin/about/statistics/index.blade.php ENDPATH**/ ?>