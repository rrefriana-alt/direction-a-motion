...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — Fugo Creative Group</title>
    <link rel="icon" href="<?php echo e(asset('assets/img/apple-touch-icon.png')); ?>">
...
<body>
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <a href="<?php echo e(route('admin.dashboard')); ?>" style="text-decoration:none">
        ...
        <ul class="sidebar-nav">
            <li><a href="<?php echo e(route('admin.home')); ?>" class="<?php echo e(request()->routeIs('admin.home') ? 'active' : ''); ?>"><i class="bi bi-house-door"></i>Home</a></li>
            <li><a href="<?php echo e(route('admin.portfolio.index')); ?>" class="<?php echo e(request()->routeIs('admin.portfolio*') ? 'active' : ''); ?>"><i class="bi bi-briefcase"></i>Work</a></li>
            <li><a href="<?php echo e(route('admin.work-settings.edit')); ?>" class="<?php echo e(request()->routeIs('admin.work-settings*') ? 'active' : ''); ?>"><i class="bi bi-gear"></i>Work Page</a></li>
            <li><a href="<?php echo e(route('admin.services.index')); ?>" class="<?php echo e(request()->routeIs('admin.services*') ? 'active' : ''); ?>"><i class="bi bi-gear"></i>Services</a></li>
            <li><a href="<?php echo e(route('admin.about.index')); ?>" class="<?php echo e(request()->routeIs('admin.about*') ? 'active' : ''); ?>"><i class="bi bi-building"></i>About</a></li>
            <li><a href="<?php echo e(route('admin.contact.index')); ?>" class="<?php echo e(request()->routeIs('admin.contact*') && !request()->routeIs('admin.career*') ? 'active' : ''); ?>"><i class="bi bi-envelope"></i>Contact</a></li>
        </ul>
        ...
        <ul class="sidebar-nav">
            <li><a href="<?php echo e(route('admin.career.index')); ?>" class="<?php echo e(request()->routeIs('admin.career*') ? 'active' : ''); ?>"><i class="bi bi-person-badge"></i>Career</a></li>
            <li><a href="<?php echo e(route('admin.news.index')); ?>" class="<?php echo e(request()->routeIs('admin.news*') ? 'active' : ''); ?>"><i class="bi bi-newspaper"></i>News</a></li>
        </ul>
        ...
        <ul class="sidebar-nav">
            <li><a href="<?php echo e(route('admin.account.index')); ?>" class="<?php echo e(request()->routeIs('admin.account*') ? 'active' : ''); ?>"><i class="bi bi-people"></i>Admin Users</a></li>
        </ul>
        <div class="sidebar-footer">
            <div class="sidebar-user">
                <div class="avatar"><?php echo e(strtoupper(substr(auth('admin')->user()->name ?? 'A', 0, 1))); ?></div>
                <div class="user-info">
                    <div class="user-name"><?php echo e(auth('admin')->user()->name ?? 'Admin'); ?></div>
    ...
    <div class="main-content">
        <div class="topbar">
            ...
            <div class="topbar-right">
                <a href="<?php echo e(url('/')); ?>" target="_blank" class="topbar-btn" title="View Website">
...
<?php /**PATH D:\Reyhan\Fugo Creative\direction-a-motion(git)\direction-a-motion\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>