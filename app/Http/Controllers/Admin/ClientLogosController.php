...
class ClientLogosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.home.clients.index')->with('success', 'Client logo berhasil ditambahkan!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, ClientLogo $clientLogo)
    {
        ...
        try {
            ...
            return redirect()->route('admin.home.clients.index')->with('success', 'Client logo berhasil diupdate!');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Error: ' . $e->getMessage())->withInput();
        }
    }
    ...
    public function destroy(ClientLogo $clientLogo)
    {
        try {
            ...
            $clientLogo->delete();
            return redirect()->route('admin.home.clients.index')->with('success', 'Client logo berhasil dihapus!');
        } catch (\Exception $e) {
    ...
    public function carouselUpdate(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.home.clients.carousel')->with('success', 'Carousel berhasil diupdate!');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Error: ' . $e->getMessage());
        }
    }
